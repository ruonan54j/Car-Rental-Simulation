...
INSERT INTO `Rentals` (`rid`, `confNo`, `startOdometer`, `startTimestamp`, `returnTimestamp`, `endOdometer`, `fullTank`, `finalCost`) VALUES
...
(1, '123abc', 'Honda', 'Civic', 2010, 'blue', 100.5, 1, 'Electrical Vehicle', 'Vancouver');
